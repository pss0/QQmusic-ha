<template>
  <div class="hello" ref="box">
    ...
    <div ref="xxx" class="xxx" v-show="issuo">
      ...
      <swiper class="hei">
        <swiper-slide>
          ...
          <div class="aos">
            <img
              :src="'https://y.gtimg.cn/music/photo_new/T002R300x300M000'+dates.albummid+'.jpg'"
          ...
          <div class="ss">
            <div class="ccfind">
              <div class="ccfindfind" ref="wrapper2">
                <ul class="lis999">
                  <li v-for="(item,inde) in currentLyric" :key="inde" :ref='Math.ceil(item.time/1000)'>{{item.txt}}</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div class="bo">
        ...
        <div class="bos">
          <img :src="issuiji?'/static/img/顺序播放.png':'/static/img/单曲循环.png'" @click="danqu" alt>
    ...
    <div class="zuixiao" v-show="isxiao" @click="da">
      <img
        :src="'https://y.gtimg.cn/music/photo_new/T002R300x300M000'+imgurl+'.jpg'"
        class="yuan"
      >
      <div class="lis">
        <p>{{songname}}</p>
...
export default {
  ...
  computed:{
    songname(){
        return this.dates.songname
    },
    singername(){
        return this.dates.singer[0].name
    },
    imgurl(){
        return this.dates.albummid
    }
  },
  watch:{
